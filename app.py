...
LANGUAGE_COMMANDS = {
    ...
    "Speak in Bengali": "এখন থেকে বাংলা বলুন।",
    "Speak in Portuguese (Brazilian)": "Fale em português brasileiro a partir de agora.",
    "Speak in Russian": "Теперь говорите по-русски.",
    "Speak in Urdu": "اب سے اردو میں بات کریں۔",
    "Speak in Indonesian/Malay": "Bercakap dalam Bahasa Melayu mulai sekarang.",  # Covers both
    "Speak in Vietnamese": "Nói tiếng Việt từ bây giờ.",
    "Speak in Japanese": "今から日本語で話してください。",
    "Speak in Turkish": "Bundan sonra Türkçe konuş.",
    "Speak in Persian (Farsi)": "از حالا به فارسی صحبت کن.",
    "Speak in Filipino (Tagalog)": "Magsalita sa Tagalog mula ngayon.",
    "Speak in Korean": "지금부터 한국어로 말하세요.",
    "Speak in Thai": "พูดภาษาไทยตั้งแต่ตอนนี้เป็นต้นไป",
    "Speak in Punjabi": "ਹੁਣ ਤੋਂ ਪੰਜਾਬੀ ਵਿੱਚ ਗੱਲ ਕਰੋ।",
    "Speak in Tamil": "இனிமேல் தமிழ் பேசுங்கள்.",
    "Speak in Telugu": "ఇప్పటి నుండి తెలుగు మాట్లాడండి.",
    "Speak in Marathi": "आता पासून मराठीत बोला.",
    "Speak in Gujarati": "હવે부터 ગુજરાતીમાં બોલો.",
    "Speak in German": "Sprich ab jetzt Deutsch.",
    "Speak in Italian": "Parla in italiano da ora in poi.",
    "Speak in Romanian": "Vorbește în română de acum înainte.",
    "Speak in Polish": "Mów teraz po polsku.",
    "Speak in Ukrainian": "Говоріть українською з цього моменту.",
    "Speak in Swahili": "Zungumza Kiswahili kuanzia sasa.",
    "Speak in Burmese": "အခုမှစပြီး မြန်မာလို ပြောပါ။",
    "Speak in Nepali": "अबदेखि नेपालीमा बोल्नुहोस्।",
    "Speak in Hebrew": "דבר עברית מהיום והלאה.",
    "Speak in Haitian Creole": "Pale kreyòl soti kounye a.",
    "Speak in Amharic": "ከአሁን ጀምሮ በአማርኛ ተናገር።",
    "Speak in Somali": "Ka hadal Af-Soomaali laga bilaabo hadda.",  # Optional to add
    "Speak in French (African)": "Parlez en français africain dès maintenant.",  # For context
    "Speak in Dutch": "Spreek vanaf nu Nederlands.",
    "Speak in Greek": "Μίλα ελληνικά από εδώ και πέρα.",
    "Speak in Czech": "Mluvte česky od teď.",
    "Speak in Hungarian": "Beszélj magyarul mostantól.",
    "Speak in Sinhala": "දැන් සිට සිංහලෙන් කතා කරන්න.",
    "Speak in Khmer": "ចាប់ពីពេលនេះនិយាយភាសាខ្មែរ។",
    "Speak in Lao": "ໃຫ້ເວົ້າພາສາລາວແຕ່ຕອນນີ້ເປັນຕົ້ນໄປ.",
    "Speak in Norwegian": "Snakk norsk fra nå av.",
    "Speak in Swedish": "Tala svenska från och med nu.",
    "Speak in Danish": "Tal dansk fra nu af.",
    "Speak in Finnish": "Puhu suomea tästä lähtien.",
    "Speak in Icelandic": "Talaðu íslensku héðan í frá.",
    "Speak in Portuguese (Portugal)": "Fala em português a partir de agora.",
    "Speak in Chinese (Traditional)": "從現在開始說中文。",
    "Speak in Kannada": "ಇನ್ನೂ ಮುಂದೆ ಕನ್ನಡದಲ್ಲಿ ಮಾತನಾಡಿ.",
}
